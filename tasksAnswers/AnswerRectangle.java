public class AnswerRectangle {
    private double width;
    private double height;

    public AnswerRectangle() {
        width = 1.0;
        height = 1.0;
    }

    public AnswerRectangle(double width, double height) {
        this.width = width;
        this.height = height;
    }
    ...
    public static void main(String[] args) {
        ...
        AnswerRectangle test = new AnswerRectangle();
        ...
        AnswerRectangle test2 = new AnswerRectangle(4, 5.5);
