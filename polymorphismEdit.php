<!DOCTYPE html>
<html>
   <!--The following code is for editing the chalkboard on the lessons page (polymorphism)-->
   <head>
      <title>
         Chalkboard Polymorphism
      </title>
   ...
   <?php
      //when the user has submitted the form this code executes and updates the lessons data in the database
         if (isset($_POST["submit"])) {
            ...
            //update the lesson data where the lessonID is 1 a.k.a the polymorphism lesson
