public class Random{
    ...
    System.out.println("the previous closing price is : " +test.EnterpreviousClosingPrice(79.45));
    System.out.println("the current price is : " +test.Entercurrentprice(79.65));
    System.out.println("the percentage change is : " +test.getChangePercentage());
   }
